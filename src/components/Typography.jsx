...
export const Header2 = ({ children, className }) => <h2 className={cn('text-5xl font-bold max-w-4/5', className)}>{children}</h2>
export const Header3 = ({ children, className }) => <h3 className={cn('text-4xl font-bold max-w-4/5', className)}>{children}</h3>
